                ...
                ?>
                    <tr id="<?= 'row' . $i; ?>">
                        ...
                        <td>
                            ...
                            <button type ="submit" class="btn btn-danger btn-sm" id="<?='cancel_button'.$i;?>" onclick="cancel(event, '<?=$i;?>', 'events','cancel', 4 );" style="display:none;"><i class="fa-solid fa-ban"></i></button>
