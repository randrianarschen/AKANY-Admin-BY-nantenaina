    ...
    <div class="card-body">
      ...
      <form method="POST" enctype="multipart/form-Data" action="#">
        ...
        <div class="form-group" style="border-color:white">
          ...
          <div>
            <span class="btn btn-file btn-success"><span id="selectImg" class="fileupload-new">Selectiioner un image</span><input type="file" name='image' class="img" id="blah" required onchange="showPreview(event);"></span>
          </div>
